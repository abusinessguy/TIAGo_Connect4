...
class ArucoDetector:
    def __init__(self):
        ...
        self.marker_dict = rospy.get_param("~marker_dict", aruco.DICT_4X4_50)
        #self.marker_size = rospy.get_param("~marker_size", 0.0525)
        self.marker_size = rospy.get_param("~marker_size", 0.03)
            ...
            for i, marker_id in enumerate(ids):
                if marker_id == 4:
                    ...
                    if pose_transformed:
                        ...
                        pickPos = self.apply_transformations(pose_transformed, translation=(0.0, 0, -0.05), rotation_euler=(0, np.pi / 2, 0))

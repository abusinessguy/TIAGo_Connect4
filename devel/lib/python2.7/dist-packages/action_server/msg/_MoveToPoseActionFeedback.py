...
"""autogenerated by genpy from action_server/MoveToPoseActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveToPoseActionFeedback(genpy.Message):
  _md5sum = "34457bd6d156bddddfc82fc14102ebdf"
  _type = "action_server/MoveToPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server/MoveToPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = action_server.msg.MoveToPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_server.msg.MoveToPoseFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback,) = _get_struct_f().unpack(str[start:end])
      return self

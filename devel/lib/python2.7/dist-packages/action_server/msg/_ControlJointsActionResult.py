...
"""autogenerated by genpy from action_server/ControlJointsActionResult.msg. Do not edit."""
import codecs
import sys
...
class ControlJointsActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "action_server/ControlJointsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server/ControlJointsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControlJointsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_server.msg.ControlJointsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_server.msg.ControlJointsResult()

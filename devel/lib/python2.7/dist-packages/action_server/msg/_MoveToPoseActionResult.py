...
"""autogenerated by genpy from action_server/MoveToPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveToPoseActionResult(genpy.Message):
  ...
  _type = "action_server/MoveToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_server/MoveToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_server.msg.MoveToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_server.msg.MoveToPoseResult()

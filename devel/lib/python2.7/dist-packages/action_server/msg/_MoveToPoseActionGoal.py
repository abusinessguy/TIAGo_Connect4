...
"""autogenerated by genpy from action_server/MoveToPoseActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MoveToPoseActionGoal(genpy.Message):
  ...
  _type = "action_server/MoveToPoseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','action_server/MoveToPoseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = action_server.msg.MoveToPoseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = action_server.msg.MoveToPoseGoal()

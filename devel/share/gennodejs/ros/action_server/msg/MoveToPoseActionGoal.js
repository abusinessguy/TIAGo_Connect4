...
class MoveToPoseActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToPoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveToPoseGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToPoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveToPoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveToPoseGoal()
    }
...
module.exports = MoveToPoseActionGoal;
